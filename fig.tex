...
\begin{document}
	\def\alph{\vphantom{\beta}\alpha}
	\def\gamm{\vphantom{\beta}\gamma}
	\begin{tikzpicture}[
			triangle/.style = {
				draw=red!50,
		...
		child {
			...
			child [level distance=13mm]{
				...
				child [level distance = 18mm] {
					node (c1) [TriNode, minimum height=18mm]{$\gamm$}
				}
			}
		};
		...
		child {
			...
			child[level distance = 24.5mm] {
				node (c2) [TriNode, minimum height=18mm] {$\gamm$}
			}
		};
