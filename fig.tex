...
%			\draw[<->, thick] (11.2, -3.9) -- node [anchor=center, right, text width= 1.5cm, text centered]{$h(t)=$\\$h+2$}(11.2, 0.1);
	...
	\begin{figure}[!h]
		...
		\tikzmath{
			\x           = 0;   %dont touch this
			\y           = 0;   %dont touch this 
			\firstArrowL = 1;   %dist between L.head and the first node
			\nodeW       = 6;   %node width
			\nodeH       = 6;   %node width
		...
		%%%%%%%%%%%%%%%%%%%%%%%%%%===---STACKFRAME---===%%%%%%%%%%%%%%%%%%%%%%%%%%
		\node (stack1)[DarkStackNode] at (\x, \y) {};
		\node (stack2)[LightStackNode, below = 0mm of stack1] {};
		\node (stack3)[DarkStackNode, below = 0mm of stack2] {};
		\node (stack4)[DarkStackNode, below = 0mm of stack3] {};
		\node (stack5)[DarkStackNode, below = 0mm of stack4] {};
		\node (stack6)[LightStackNode, below = 0mm of stack5] {};
		\node (stack7)[DarkStackNode, below = 0mm of stack6] {};
		\node (stack8)[LightStackNode, below = 0mm of stack7] {};
		\node (stack9)[LightStackNode, below = 0mm of stack8] {};
		\node (stack10)[DarkStackNode, below = 0mm of stack9] {};
		%%%%%%%%%%%%%%%%%%%%%%%%%%===---UNIVERSE---===%%%%%%%%%%%%%%%%%%%%%%%%%%
		\node (univ)[
			ellipse, 
			minimum width = 6cm, 
		...
		\node (k3) [Point, label = left:$k_3$] at ($(actual) + (0.4, -1.3)$) {};
		\draw[->,thick] (k3) -- (stack8);
		
		\node (k6) [Point, label = left:$k_6$] at ($(actual) + (1.5, -0.7)$) {};
		...
		%%%%%%%%%%%%%%%%%%%%%%%%%%===---FOURTH LINE---===%%%%%%%%%%%%%%%%%%%%%%%%%%
			...
			\node (41m) [Node,right = 0mm of 41l]                    {9};
			\node (41r) [Node,right = 0mm of 41m]                    {};
		\draw[->, thick] ($(stack9)$) -- (41l);
		
			\node (42l) [Node,right = \nodeDist cm of 41r]           {};
			\node (42m) [Node,right = 0mm of 42l]                    {16};
			\node (42r) [Node,right = 0mm of 42m]                    {};
