...
%	
	...
	\begin{figure}[!h]
		...
		\tikzmath{
			...
			\nodeW       		 = 5;   %node width
			\nodeH       		 = 5;   %node width
			\nodeDist    		 = 0.8;   %distance between nodes
			\figDist     		 = 1.2; %distance between each 
		...
		\node (firstHead0) [EmptyNode] at (\x,\y + \figDist) {\textit{L.head}};
			\node (01l) [Node,right = \firstArrowL cm of firstHead0] {};
			\node (01m) [Node,right = 0mm of 01l]                    {9};
			\node (01r) [Node,right = 0mm of 01m]                    {};
		\draw[->, thick] (firstHead0) -- (01l);
		\draw[->, thick] ($(01r) + (upperArrowStart)$) -- 
						 ($(01r) + (aboveArrow)$) -- 
						 ($(01l) + (aboveArrow) + (-0.6,0)$) -- 
						 ($(01l) + (upperArrowEnd) + (-\nodeH/2/10,0)$) -- 
						 ($(01l) + (upperArrowEnd)$);
		\draw[->, thick] ($(01l) + (lowerArrowStart)$) -- 
						 ($(01l) + (belowArrow)$) -- 
						 ($(01r) + (belowArrow) + (0.6,0)$) -- 
						 ($(01r) + (lowerArrowEnd) + (\nodeH/2/10,0)$) -- 
						 ($(01r) + (lowerArrowEnd)$);
		...
		\draw[->, thick] ($(14r) + (upperArrowStart)$) -- 
					 	 ($(14r) + (aboveArrow)$) -- 
				 		 ($(11l) + (aboveArrow) + (-0.6,0)$) -- 
						 ($(11l) + (upperArrowEnd) + (-\nodeH/2/10,0)$) -- 
						 ($(11l) + (upperArrowEnd)$);
						 
		\draw[->, thick] ($(11l) + (lowerArrowStart)$) -- 
						 ($(11l) + (belowArrow)$) -- 
						 ($(14r) + (belowArrow) + (0.6,0)$) -- 
						 ($(14r) + (lowerArrowEnd) + (\nodeH/2/10,0)$) -- 
						 ($(14r) + (lowerArrowEnd)$);
		...
		\draw[->, thick] ($(25r) + (upperArrowStart)$) -- 
						 ($(25r) + (aboveArrow)$) -- 
						 ($(21l) + (aboveArrow) + (-0.6,0)$) -- 
						 ($(21l) + (upperArrowEnd) + (-\nodeH/2/10,0)$) -- 
						 ($(21l) + (upperArrowEnd)$);
		
		\draw[->, thick] ($(21l) + (lowerArrowStart)$) -- 
						 ($(21l) + (belowArrow)$) -- 
						 ($(25r) + (belowArrow) + (0.6,0)$) -- 
						 ($(25r) + (lowerArrowEnd) + (\nodeH/2/10,0)$) -- 
						 ($(25r) + (lowerArrowEnd)$);
		...
		\draw[->, thick] ($(34r) + (upperArrowStart)$) -- 
						 ($(34r) + (aboveArrow)$) -- 
						 ($(31l) + (aboveArrow) + (-0.6,0)$) -- 
						 ($(31l) + (upperArrowEnd) + (-\nodeH/2/10,0)$) -- 
						 ($(31l) + (upperArrowEnd)$);
		
		\draw[->, thick] ($(31l) + (lowerArrowStart)$) -- 
						 ($(31l) + (belowArrow)$) -- 
						 ($(34r) + (belowArrow) + (0.6,0)$) -- 
						 ($(34r) + (lowerArrowEnd) + (\nodeH/2/10,0)$) -- 
						 ($(34r) + (lowerArrowEnd)$);
		\end{tikzpicture}
